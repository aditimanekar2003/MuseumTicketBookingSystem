...
const RelatedMuseums = ({ speciality, docId }) => {
    ...
    useEffect(() => {
        if (Museums.length > 0 && speciality) {
            const MuseumsData = Museums.filter((doc) => doc.speciality === speciality && doc._id !== docId)
            setRelDoc(MuseumsData)
        }
    }, [Museums, speciality, docId])

    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Related Museums</h1>
