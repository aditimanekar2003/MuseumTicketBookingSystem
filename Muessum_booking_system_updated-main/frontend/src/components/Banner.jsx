...
                    <p>Museum Ticket Booking</p>
                    <p className='mt-4'>Explore 100+ Museums of India</p>
                </div>
...
                <img className='w-full absolute bottom-0 right-0 max-w-md' src={assets.Booking_img} alt="Museum Booking" />
            </div>
        </div>
    )
}
