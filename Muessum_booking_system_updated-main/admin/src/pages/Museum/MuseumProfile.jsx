...
const MuseumProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(MuseumContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/Museum/update-profile', updateData, { headers: { dToken } })
